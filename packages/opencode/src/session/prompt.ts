            ...
            const outcome: "break" | "continue" = yield* Effect.onExit(
              Effect.gen(function* () {
                ...
                const coordinateGuidance = currentMode === "COORDINATE" ? [
                  ...
                  "",
                  "### 1. Xethryon Swarm (team_create → task_create → team_await)",
                  ...
                  "IMPORTANT: After creating tasks, call `team_await` to block until all tasks complete. Do NOT manually poll with task_get/task_list.",
                  "",
