...
export function getAutonomyPrompt(): string | undefined {
  ...
  return [
    ...
    "and need to write files, or you're in EXPLORE and need to edit code), you MUST immediately",
    "switch to the appropriate mode and DO the work. NEVER tell the user 'I can't do that in this",
    "mode' or 'switch to X mode and ask again'. Just switch and execute. That's the whole point",
    "of autonomy — seamless capability escalation without user intervention.",
    "",
