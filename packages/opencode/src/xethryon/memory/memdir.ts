...
export function buildMemoryLines(
  ...
  const howToSave = [
        ...
        "Examples: `user-coding-style.md`, `postgresql-schema-design.md`, `api-naming-convention.md`",
        "",
        "#### `knowledge/connections/` — multi-concept relationships (USE THIS for flows, integrations, tradeoffs)",
        "Articles that connect 2+ existing concepts with [[wikilinks]]. Workflows, data flows, architecture decisions that span multiple systems.",
        "Examples: `order-placement-flow.md` (links [[api-versioning]] + [[integer-money-storage]] + [[redis-caching]]),",
        "`auth-vs-rate-limiting-tradeoff.md` (links [[jwt-auth]] + [[rate-limiting]])",
        "**Rule: if your article references 2+ existing concepts, it belongs in connections/ not concepts/**",
        "",
