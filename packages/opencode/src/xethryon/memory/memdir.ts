...
export function buildMemoryLines(
  ...
  const howToSave = [
        ...
        "",
        "#### `knowledge/concepts/` — single-topic facts",
        "One concept per file. User preferences, tech stack choices, conventions, team info, deadlines.",
        "",
        "#### `knowledge/connections/` — multi-concept relationships",
        "Articles that connect 2+ existing concepts with [[wikilinks]]. Workflows, data flows, architecture decisions.",
        "**Rule: if your article references 2+ existing concepts, it goes in connections/ not concepts/**",
        "",
        "#### `knowledge/qa/` — direct answers",
        "Quick Q&A pairs. 'How do we deploy?' 'What's the DB password policy?'",
        "",
        "#### Create new folders as needed (SELF-ORGANIZING)",
        "You are NOT limited to the 3 folders above. Create new `knowledge/<category>/` folders when it makes sense for the project:",
        "- `knowledge/people/` — team members, roles, contacts",
        "- `knowledge/tools/` — tech stack details, configs, versions",
        "- `knowledge/techniques/` — patterns, algorithms, approaches",
        "- `knowledge/decisions/` — ADRs, why X over Y",
        "- Or any category that fits — `endpoints/`, `schemas/`, `mechanics/`, etc.",
        "",
        "The folder structure should evolve to match the project. Let the knowledge organize itself.",
        "",
        "### Article format",
        "",
